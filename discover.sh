...
echo " "
echo "$(tput setaf 4) FOUND [$(cat ./output/$1.live_subnets.log | wc -l)] SUBNETS IN ./output/$1.live_subnets.log AND [$(cat ./output/$1.live_subdomains.log | wc -l)] SUBDOMAINS in ./output/$1.live_subdomains.log."
find ./output -size  0 -print -delete 2> /dev/null
echo " "
